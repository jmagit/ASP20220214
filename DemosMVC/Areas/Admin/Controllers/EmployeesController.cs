...
namespace DemosMVC.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(TiendaDbContext context)
        {
            _context = context;
        }
        ...
        {
            var tiendaDbContext = _context.Employees.Include(e => e.BusinessEntity);
